    ...
    return (    
        <>
            ...
            <Box sx={{ my: 3, mx: 3, width: '50%' }}>
                <Snackbar open={sucesso} autoHideDuration={6000} anchorOrigin=
                ...
                <Snackbar open={error.length > 0} autoHideDuration={6000} anchorOrigin=
                    {{ vertical: 'top', horizontal: 'center' }}>
                ...
                <TextField label="Nome" variant="standard" fullWidth sx={{ mb: 2 }}
                    onChange={(e) => { setNome(e.target.value) }} value={nome} />
                <TextField label="Valor" variant="standard" fullWidth sx={{ mb: 2 }}
                ...
                />
                {fotoAtual && (<img src={fotoAtual} style={{ width: '100%' }} alt="oi" />)}
                <TextField label="Descrição" variant="standard" fullWidth sx={{ mb: 2, mt: 3 }}
                    onChange={(e) => { setDescricao(e.target.value) }} value={descricao} />
                <TextField label="Quantidade Em Estoque" variant="standard" fullWidth
                    sx={{ mb: 2 }} onChange={(e) => { setQuantidade(e.target.value) }} value={quantidade} />
                <LoadingButton
                    color='error'
                    variant='contained'
                    fullWidth
